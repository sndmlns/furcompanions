        ...
        <div class="row pb-3">
            <div class="col-lg-4 mb-4">
                <div class="card border-0 mb-2">
                    ...
                    <div class="card-body bg-light p-4">
                        <h4 class="card-title text-truncate">With the same pain but no pain</h4>
                        <div class="d-flex mb-3">
                            <small class="mr-2"><i class="fa fa-user text-muted"></i> Admin</small>
                            <small class="mr-2"><i class="fa fa-folder text-muted"></i> Web Design</small>
                            <small class="mr-2"><i class="fa fa-comments text-muted"></i> 15</small>
                        </div>
                        <p>"Spaying is a surgical procedure for female pets to prevent pregnancy, reduce health risks, and improve behavior."</p>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 mb-2">
                    ...
                    <div class="card-body bg-light p-4">
                        <h4 class="card-title text-truncate">Play with us!</h4>
                        <div class="d-flex mb-3">
                            <small class="mr-2"><i class="fa fa-user text-muted"></i> Admin</small>
                            <small class="mr-2"><i class="fa fa-folder text-muted"></i> Web Design</small>
                            <small class="mr-2"><i class="fa fa-comments text-muted"></i> 15</small>
                        </div>
                        <p>"Enjoying a fun playtime session with my dog!"</p>
                        <a class="font-weight-bold" href="">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card border-0 mb-2">
                    ...
                    <div class="card-body bg-light p-4">
                        <h4 class="card-title text-truncate">Look, who are with me?</h4>
                        <div class="d-flex mb-3">
                            <small class="mr-2"><i class="fa fa-user text-muted"></i> Admin</small>
                            <small class="mr-2"><i class="fa fa-folder text-muted"></i> Web Design</small>
                            <small class="mr-2"><i class="fa fa-comments text-muted"></i> 15</small>
                        </div>
                        <p>Staycation with my dogs. So much fun!</p>
                        <a class="font-weight-bold" href="">Read More</a>
                    </div>
                </div>
            </div>
