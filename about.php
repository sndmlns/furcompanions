    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                ...
                <h5 class="text-muted mb-3">At FurCompanions, we are dedicated to providing the highest quality care and services for your beloved pets. Our team of experienced professionals is passionate about creating a safe, nurturing environment for all animals in our care. Whether it's for a day of daycare or an extended boarding stay, we ensure every pet feels at home.</h5>
                <p class="mb-4">We believe in the importance of treating each pet with the love and attention they deserve. Our facilities are equipped with modern amenities, and our staff is trained to handle pets with the utmost care. Trust FurCompanions to be your partner in providing a happy and healthy life for your furry friends.</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 py-5 py-lg-0 px-3 px-lg-5">
                    ...
                    <p class="mb-4">At FurCompanions, we go above and beyond to provide special care for your pets. From tailored play sessions to individualized feeding plans, we ensure each pet's unique needs are met. Our compassionate and attentive staff treat your pets like family, giving you peace of mind while you're away.</p>
                    <div class="row py-2">
                        <div class="col-6">
    ...
    <div class="container mt-5 pt-5 pb-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="team card position-relative overflow-hidden border-0 mb-4">
                    <img class="card-img-top custom-image" src="img/team-4.jpg" alt="">
                    <div class="card-body text-center p-0">
                        <div class="team-text d-flex flex-column justify-content-center bg-light">
                            <h5>Rochelle Ann </h5>
                            <i>Member</i>
